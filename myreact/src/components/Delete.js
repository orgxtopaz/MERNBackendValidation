...
function Delete() {
  ...
  useEffect(() => {
    if (isLoaded) {
      Axios.get(`http://localhost:5000/view/${deleteId}`).then(
        (response) => {
  ...
  const deleteUser = () => {
    ...
    function save() {
      ...
      Axios.delete(`http://localhost:5000/delete/${deleteId}`).then(
        (response) => {
     ...
     <div className="container" style={{top:"330px",height:"395px"}}>
          ...
          <div className="text-container" style={{left:"230px"}}>
            ...
            <div className="form-group">
              <input
                type="email"
                value={"💌 Email Address: "+userDetails.email}
                className="form-control"
                 style={{width:"90%"}}
                 readOnly
            ...
            <div className="form-group">
              <input
                type="text"
                 style={{width:"90%"}}
                value={"📞 Contact Number: "+userDetails.contactNumber}
                className="form-control"
                readOnly
              />       
              <p></p>
            ...
            <div className="form-group">
              <input
                type="text"
                 style={{width:"90%"}}
                value={"🌍 Location: "+userDetails.location}
                className="form-control"
                readOnly
